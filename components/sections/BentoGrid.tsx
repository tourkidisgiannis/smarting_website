    ...
    <section className="py-24 bg-background relative">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold tracking-wide mb-4 text-white leading-tight">
            Οι Υπηρεσίες <span className="text-primary">Μας</span>
          </h2>
          <p className="text-foreground/80 text-lg">
            Εξερευνήστε τις κατηγορίες υπηρεσιών μας και βρείτε ακριβώς αυτό που
            ψάχνετε.
          </p>
        </div>
          ...
          {categories.map((category, index) => {
            ...
            return (
              <div
                key={category.id}
                className={cn(
                  "category-card group relative rounded-3xl border border-white/10 bg-linear-to-br from-zinc-900/90 via-zinc-900/60 to-zinc-900/30 overflow-hidden hover:border-primary/50 transition-all duration-500 hover:shadow-lg hover:shadow-primary/20 cursor-pointer",
                  spanClasses
                )}
                onClick={() => {
              ...
              >
                ...
                <div className="absolute inset-0 z-20 bg-zinc-950/90 backdrop-blur-md p-3 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 flex flex-col">
