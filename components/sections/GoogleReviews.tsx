    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-primary/10 pb-8">
        <div>
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            <span className="flex items-center text-primary font-medium">
              ...
              <Star className="ml-1 w-4 h-4 fill-primary" />
            </span>
            <span>•</span>
        ...
        {source === "google" && (
          <Badge
            variant="outline"
            className="gap-1.5 py-1.5 px-3 border-blue-500/30 text-blue-500 bg-blue-500/5"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {reviews.map((review) => (
          <Card
            key={review.id}
            className="group relative bg-card border-muted hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300"
          >
